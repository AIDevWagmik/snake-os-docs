...
* If 10+ minutes have passed without notification, DM us via X with the match ID
...
* If your opponent disappears: currently no auto-cancel for stuck `ready` matches. DM us via X with the match ID and we'll manually cancel + refund both sides.
...
4. DM us via X with a screenshot of the final score + match ID
...
4. If 5+ minutes pass and balance still 0, DM us via X with the match ID
