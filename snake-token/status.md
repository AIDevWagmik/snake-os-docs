...
| W3 — $SNAKE Launch | Target |
| M2 — Season 1 | Post-launch |
| M3+ — Platform | Long-term |

## What Happens When $SNAKE Launches
...
6. The reward system starts fresh — all the "earned" numbers showing during beta are wiped to zero. Real $SNAKE starts accumulating from the first post-launch action you take.

## Why "NOT Live Yet" Matters

If you're reading the UI literally:

* "You've earned 250,000 $SNAKE" — placeholder. Not real $SNAKE. Will not be claimable.
* "1,500,000 $SNAKE in claimable rewards" — placeholder. Will be zeroed at launch.
* Solo-grinder accounts will not get a single $SNAKE from pre-launch activity.
...
* ❌ $SNAKE is NOT real yet. Anything labeled "$SNAKE" is a placeholder.
